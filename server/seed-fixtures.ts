export const COFLAT_SHOWCASE_PAGE_PATH = "coflat-feature-showcase.md";
export const COFLAT_SHOWCASE_BIB_PATH = "reference.bib";
export const COFLAT_SHOWCASE_IMAGE_PATH = "showcase/hover-preview-figure.svg";

export const COFLAT_SHOWCASE_ISSUE_TITLE = "Rendering fixture: Coflat feature showcase";

export const COFLAT_SHOWCASE_BIB = `@book{cormen2009,
...
export const COFLAT_SHOWCASE_IMAGE = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 140" role="img" aria-labelledby="title desc">
...
export function coflatFeatureShowcase(workspaceName: string): string {
  return [
    "---",
    ...
    "---",
    "",
    `This is the canonical single-page Coflat showcase for ${workspaceName}. It exercises the editor's main document surfaces in one place: frontmatter, inline rendering, display math, semantic blocks, figures, tables, code, references, citations, footnotes, and structure-edit behavior.`,
    "",
    ...
    "",
    '::: {#cor:rank-reduction-from-bounded-gap .theorem title="Rank Reduction"}',
    "This seeded block keeps the old Cogirth outline regression durable without depending on the live Cogirth document.",
    ":::",
    "",
    "# Proof of [@cor:rank-reduction-from-bounded-gap]",
    "",
    "This exact-key fixture should show `Proof of Theorem 4` in reader and editor outlines.",
    "",
    ...
    "",
    `![Local hover-preview figure](${COFLAT_SHOWCASE_IMAGE_PATH}) should render as an inline image without relying on a remote placeholder.`,
    "",
