...
compose() {
  sudo -n --preserve-env=COSHEAF_GIT_SHA,COSHEAF_ENV_DIR,COSHEAF_PREVIEW_SLUG,COSHEAF_PREVIEW_BRANCH,COSHEAF_PREVIEW_PORT,COSHEAF_PREVIEW_EXPIRES_AT,JUPITER_TAILSCALE_IP,NPM_CONFIG_REGISTRY \
