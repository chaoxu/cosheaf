...
const rules = [
  ...
  },
  {
    ...
    commands: [
      ...
      command("pnpm smoke:reader-parity", "seeded Coflat outline/hover/geometry parity"),
  ...
  },
  {
    ...
    commands: [
      ...
      command("pnpm exec vitest run server/local/local-annotations.test.ts server/local/local-app.test.ts src/cosheaf/api.test.ts", "local annotation, suggesting, and client route coverage"),
      command("pnpm smoke:workbench-annotations", "local Workbench annotation and suggesting browser smoke"),
    ],
  },
  {
    id: "coflat-parity",
    ...
    commands: [
      ...
      command("pnpm smoke:reader-parity", "Coflat showcase reader/editor outline, hover, and geometry parity"),
